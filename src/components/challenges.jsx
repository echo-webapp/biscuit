...
const rewarded_arr = [
  ...
  {
    image: image2,
    heading: "Calculate the number of queries answered by Google per second.",
    title: "Ends in  11 d : 12hr ",
    price: "1,0009",
    share: "2",
    brandLogo: imageD,
...
const solve_problems_arr = [
  ...
  {
    image: image2,
    heading: "Amazon: Increase user traction?",
    title: "Challenge",
    views: "59",
    share: "2",
    SocialMedia: [pinterest],
    ...
    <>
      <>
        <div className=" font-semibold  gap-8 my-10 flex-wrap w-5/6" style={{}}>
          ...
          <p style={{ color: "#54577A", fontWeight: "400", fontSize: "16px" }}>
            Solve problems & get rewards from companies
          </p>
        </div>
        <MainContainer>
      ...
      <>
        <div className=" font-semibold  gap-8 my-10 flex-wrap w-5/6" style={{}}>
          ...
          <p style={{ color: "#54577A", fontWeight: "400", fontSize: "16px" }}>
            Over 2,000 questions from the best tech companies
          </p>
        </div>
        <MainContainer style={{ marginBottom: "48px" }}>
